...

{
          ...
          <Modal.Footer className="p-5 w-full items-end justify-end">
            ...
            <div className='mb-4 mt-2'>
                <button className='btn-def create-btn' style={{width: '290px'}} onClick={() => {setOpenModal(!openModal)}}>
                Criar categoria
                </button>
            </div>
            {
                ...
                <div className={openModal ? "relative overflow-x-auto w-full opacity-[0.3]" : "relative overflow-x-auto w-full"}>
